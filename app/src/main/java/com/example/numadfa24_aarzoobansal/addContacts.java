...
//
//
//public class AddContacts2 extends AppCompatActivity {
//
...
//        userAlternateNo = findViewById(R.id.alternatePhoneNo);
//
//
//        Toolbar toolbar = (Toolbar) findViewById(R.id.addContactstoolbar2);
...
//            }
//
////            This code will help us to pass data from current activity to another activity
////            Intent intent = new Intent();
////            intent.putExtra("user_name", user_name);
////            intent.putExtra("user_phone", user_phone);
////
////            //If the user email is empty send an empty text. Else send an value entered by the user
////            if(user_email.isEmpty()){
...
////
////            if(user_alternate_number.isEmpty()){
////                intent.putExtra("user_alternate_no", "");
////            }else{
////                intent.putExtra("user_alternate_no", user_alternate_number);
////            }
////
////            Log.v("result code in child ",String.valueOf(RESULT_OK));
////
